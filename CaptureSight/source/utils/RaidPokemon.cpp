...
u32 RaidPokemon::GetEC() {
  return this->EC;
}

u32 RaidPokemon::GetPID() {
  return this->PID;
}

u16 RaidPokemon::GetSpecies() {
  return this->species;
}

bool RaidPokemon::GetIsShiny() {
  return this->isShiny;
}

std::vector<s8> RaidPokemon::GetIVs() {
  return this->IVs;
}
