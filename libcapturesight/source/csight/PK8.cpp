...
namespace csight {
  ...
  PK8::~PK8() { delete[] this->data; }

  bool PK8::CheckEncrypted() { return *(u16*)(this->data + 0x70) != 0 && *(u16*)(this->data + 0xC0) != 0; }
  ...
  u32 PK8::GetEncryptionConstant() { return *(u32*)this->data; }
  ...
  u8 PK8::GetEV(u8 stat) { return *(u8*)(this->data + 0x26 + stat); }
  ...
  u16 PK8::GetTID() { return *(u16*)(this->data + 0xc); }

  u16 PK8::GetSID() { return *(u16*)(this->data + 0xe); }

  u32 PK8::GetPID() { return *(u32*)(this->data + 0x1c); }
  ...
  u16 PK8::GetMove(u8 slot) { return *(u16*)(this->data + 0x72 + (slot * 2)); }
  ...
  u8 PK8::GetMovePP(u8 slot) { return *(u16*)(this->data + 0x7A + slot); }

  bool PK8::GetIsEgg() { return this->GetIsValid() && ((this->GetIV32() >> 30) & 1) == 1; }

  u8 PK8::GetAbility() { return *(u8*)(this->data + 0x14); }

  u8 PK8::GetNature() { return *(u8*)(this->data + 0x20); }

  u8 PK8::GetMintedNature() { return *(u8*)(this->data + 0x21); }

  u16 PK8::GetChecksum() { return *(u16*)(this->data + 0x6); }
  ...
  u8 PK8::GetCurrentHandler() { return *(u8*)(this->data + 0xC4); }

  u8 PK8::GetHTFriendship() { return *(u8*)(this->data + 0xC8); }

  u8 PK8::GetOTFriendship() { return *(u8*)(this->data + 0x112); }
