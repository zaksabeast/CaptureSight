...
namespace csight {
  GameReader::GameReader() { this->isDebugServiceRunning = checkIfServiceIsRunning("dmnt:cht"); }
  ...
  bool GameReader::GetIsServiceRunning() { return this->isDebugServiceRunning; }
  ...
  std::vector<std::shared_ptr<PK8>> GameReader::ReadParty() { return this->ReadPK8s(this->partyOffset, 6, 0x158); }

  std::vector<std::shared_ptr<PK8>> GameReader::ReadBoxes() { return this->ReadPK8s(this->boxOffset, 960, 0x158); }
  ...
  std::shared_ptr<PK8> GameReader::ReadRaid() { return this->ReadPK8(this->raidOffset); }

  std::shared_ptr<PK8> GameReader::ReadTrade() { return this->ReadPK8(this->tradeOffset); }

  u64 GameReader::GetTitleId() { return this->metadata.title_id; }
